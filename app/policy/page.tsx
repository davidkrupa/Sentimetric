  ...
  return (
    <>
      ...
      <div className="flex flex-col items-start gap-4 max-w-screen-xl mx-auto px-2 md:px-6 lg:px-12 text-slate-500 pb-12 pt-32 relative">
        ...
        <h2 className="text-slate-100 text-xl font-medium mt-4">
          Interpretation and Definitions
        </h2>
        <h3 className="text-slate-100 text-lg font-medium">Interpretation</h3>
        <p>
        ...
        <h3 className="text-slate-100 text-lg font-medium mt-4">Definitions</h3>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Sentimetric.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Sentimetric, accessible from{" "}
              <a
                href="https://www.sentimetric.net/"
        ...
        <h3 className="text-slate-100 text-lg font-medium mt-4">
        ...
        <h2 className="text-slate-100 text-xl font-medium mt-4">Cookies</h2>
        <p>We don't use any tracking cookies.</p>
        <p>
          The only cookies we use are necessary for the website to work, like
          signing into your account or processing payments.
        </p>
        <h3 className="text-slate-100 text-lg font-medium mt-4">
        ...
        <h2 className="text-slate-100 text-xl font-medium mt-4">Contact Us</h2>
        <p>
          If you have any questions about this Privacy Policy, You can contact
          us:
        </p>
        <ul>
          <li>By email: dawidkrupadev@gmail.com</li>
        </ul>
      </div>
      <Footer />
    </>
